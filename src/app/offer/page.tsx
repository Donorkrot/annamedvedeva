...
function OfferRu() {
  return (
    <>
      <h1 className="legal-mobile-title">ПУБЛИЧНАЯ ОФЕРТА</h1>
...
function OfferUa() {
  return (
    <>
      <h1 className="legal-mobile-title">ПУБЛІЧНА ОФЕРТА</h1>
      <div className="legal-mobile-body">
        ...
        <ul>
          ...
          <li>Якщо Користувач не з&rsquo;явився та не попередив, послуга вважається наданою, кошти не повертаються</li>
        </ul>
        ...
        <ul>
          ...
          <li>У разі розстрочки зобов&rsquo;язання щодо оплати зберігаються</li>
        ...
        <ul>
          ...
          <li>Послуги мають суб&rsquo;єктивний характер</li>
...
function OfferEn() {
  return (
    <>
      <h1 className="legal-mobile-title">PUBLIC OFFER</h1>
      <div className="legal-mobile-body">
...
export default function OfferPage() {
  ...
  // Offer page bg (mobile cream card / desktop JPG with cream bg) makes the
